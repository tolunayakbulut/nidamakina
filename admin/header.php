      			...
      			<ul class="sidebar-menu">
			        ...
			        <?php 
						if($_SESSION['user']['role'] == 'Super Admin' 
					      || $_SESSION['user']['role'] == 'Admin'):
					?>
			        <li class="treeview <?php if( ($cur_page == 'setting-email.php') ) {echo 'active';} ?>">
			          <a href="setting-email.php">
			            <i class="fa fa-cog"></i> <span>Email Configuration</span>
			          </a>
			        </li>
			        <?php endif; ?>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'setting-captcha.php')||($cur_page == 'captcha.php')) {echo 'active';} ?>">
						<a href="#">
						...
						<ul class="treeview-menu">
							<li><a href="setting-captcha.php"><i class="fa fa-circle-o"></i> Captcha Setting</a></li>
							<li><a href="captcha.php"><i class="fa fa-circle-o"></i> Captcha</a></li>
						</ul>
					</li>
					...
					<li class="treeview <?php if( ($cur_page == 'file-add.php')||($cur_page == 'file.php')||($cur_page == 'file-edit.php') ) {echo 'active';} ?>">
			          <a href="file.php">
			            <i class="fa fa-download"></i> <span>File Upload (Media)</span>
			          </a>
			        </li>
