...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		if($path == '' && $path1 == '') {
			$statement = $pdo->prepare("UPDATE tbl_doctor SET name=?, slug=?, designation_id=?, degree=?, detail=?, facebook=?, twitter=?, linkedin=?, youtube=?, google_plus=?, instagram=?, flickr=?, address=?, practice_location=?, phone=?, email=?, website=?, status=?, meta_title=?, meta_keyword=?, meta_description=? WHERE id=?");
		...
		if($path != '' && $path1 == '') {
			...
			$statement = $pdo->prepare("UPDATE tbl_doctor SET name=?, slug=?, designation_id=?, photo=?, degree=?, detail=?, facebook=?, twitter=?, linkedin=?, youtube=?, google_plus=?, instagram=?, flickr=?, address=?, practice_location=?, phone=?, email=?, website=?, status=?, meta_title=?, meta_keyword=?, meta_description=? WHERE id=?");
		...
		if($path == '' && $path1 != '') {
			...
			$statement = $pdo->prepare("UPDATE tbl_doctor SET name=?, slug=?, designation_id=?, banner=?, degree=?, detail=?, facebook=?, twitter=?, linkedin=?, youtube=?, google_plus=?, instagram=?, flickr=?, address=?, practice_location=?, phone=?, email=?, website=?, status=?, meta_title=?, meta_keyword=?, meta_description=? WHERE id=?");
		...
		if($path != '' && $path1 != '') {
			...
			$statement = $pdo->prepare("UPDATE tbl_doctor SET name=?, slug=?, designation_id=?, photo=?, banner=?, degree=?, detail=?, facebook=?, twitter=?, linkedin=?, youtube=?, google_plus=?, instagram=?, flickr=?, address=?, practice_location=?, phone=?, email=?, website=?, status=?, meta_title=?, meta_keyword=?, meta_description=? WHERE id=?");
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<img src="../assets/uploads/<?php echo $photo; ?>" alt="Doctor Photo" style="width:200px;">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<img src="../assets/uploads/<?php echo $banner; ?>" alt="Doctor Banner" style="width:200px;">
							</div>
						</div>
						<div class="form-group">
