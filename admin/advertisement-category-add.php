...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("SHOW TABLE STATUS LIKE 'tbl_advertisement_category'");
		$statement->execute();
		...
		$statement = $pdo->prepare("INSERT INTO tbl_advertisement_category (adv_photo,adv_url) VALUES (?,?)");
