...
if(isset($_POST['form9'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE tbl_settings SET preloader_status=?,website_name=? WHERE id=1");
	$statement->execute(array($_POST['preloader_status'],$_POST['website_name']));

	$success_message = 'Other setting is updated successfully.';
}
?>
          					...
          					<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
							            ...
							            <div class="col-sm-6" style="padding-top:6px;background: #eee;width:auto;">
