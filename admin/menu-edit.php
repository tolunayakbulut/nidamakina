		...
		<div class="col-md-12">
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
                    ...
                    <li class="<?php if($menu_type == 'Category') {echo 'active';} ?>"><a href="#tab_2" data-toggle="tab">Category as Menu</a></li>
					<li class="<?php if($menu_type == 'Other') {echo 'active';} ?>"><a href="#tab_3" data-toggle="tab">Other Menu</a></li>
				</ul>
				<div class="tab-content">
                                                ...
                                                foreach ($res as $row) {
                                                    ...
                                                    if( $row['page_id']==0 && $row['category_id']==0 ) {      
                                                        ...
                                                        if($row['category_id']!=0) {
                                                            ...
                                                            $res1 = $r->fetchAll();
                                                            foreach ($res1 as $row1) {
                                                                echo '<option value="'.$row['menu_id'].'" '.$sel1.'>'.$row1['category_name'].'</option>';
                                                            }
                                                        }
                                                    }
                                                }
                    ...
                    <div class="tab-pane <?php if($menu_type == 'Category') {echo 'active';} ?>" id="tab_2">
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_category">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
      				...
      				<div class="tab-pane <?php if($menu_type == 'Other') {echo 'active';} ?>" id="tab_3">
						<form class="form-horizontal" action="" method="post">
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Menu URL </label>
										<div class="col-sm-4">
